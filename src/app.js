...
const staffPaymentsRoutes = require('./routes/staffPayments.routes');
...
app.use('/api/staff/payments', staffPaymentsRoutes);
...
app.use('/api/admin/login-logs', loginLogRoutes);
